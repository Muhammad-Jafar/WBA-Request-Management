      ...
      <div class="row d-flex justify-content-center">
          <div class="card card-rounded">
            <div class="card-body">
              ...
              <?php } ?>
              <?=form_open_multipart('regis_pengguna/registepen', array('method'=>'post'));?>
              ...
              <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group row">
                      <label class="col-sm-3 col-form-label">NITK / NIP</label>
                      <div class="col-sm-9">
                  ...
                  <input type="hidden" name="id_bidang" value="4" class="form-control">
