        ...
        <div class="card-body grid-margin">
          ...
          <h4 class="card-title"><?=$title_page;?></h4>
            ...
            <?php endif; ?>
              ...
              <?=form_open('pengguna/add_keluhan/', $data_keluhan->id_dkeluhan, array('method'=>'post'));?>
              <input type="hidden" name="id_dkeluhan" class="form-control" value="<?=$data_keluhan -> id_dkeluhan;?>">
                ...
                <!-- <div class="row"> -->
				  ...
				  <div class="col-md-6">
                    <div class="form-group row">
                      ...
                      <div class="col-sm-9">
                        <input type="text" name="keluhan" class="form-control" value="<?=$data_keluhan->keluhan;?>"/>
                      </div>
                    </div>
                  </div>
                <!-- </div> -->
