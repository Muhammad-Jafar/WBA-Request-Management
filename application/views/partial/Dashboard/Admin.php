          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right">Data Kebutuhan</p>
                  <div class="fluid-container">
              ...
              <p class="text-muted mt-3 mb-0">
                <i class="mdi mdi-treasure-chest mr-1" aria-hidden="true"></i> Jumlah seluruh data kebutuhan
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right">Data Keluhan</p>
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$total_dataizin;?></h3>
                  </div>
                </div>
              ...
              <p class="text-muted mt-3 mb-0">
                <i class="mdi mdi-treasure-chest mr-1" aria-hidden="true"></i> Jumlah seluruh data keluhan
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right">Kebutuhan Terkonfirmasi </p>
                  <div class="fluid-container">
              ...
              <p class="text-muted mt-3 mb-0">
                <i class="mdi mdi-checkbox-multiple-marked-outline mr-1" aria-hidden="true"></i> Jumlah kebutuhan terkonfirmasi
              </p>
            </div>
          </div>
        </div>
          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right">Keluhan Terkonfirmasi</p>
                  <div class="fluid-container">
                    <h3 class="font-weight-medium text-right mb-0"><?=$total_izinterkonfirmasi;?></h3>
                  </div>
                </div>
          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="mb-0 text-right"> Data Pegawai</p>
                  <div class="fluid-container">
