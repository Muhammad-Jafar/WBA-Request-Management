          ...
          <div class="card card-rounded">
            <div class="card-body">
              ...
              <div class="alert alert-info">
                <label style="font-size: 13px; justify-content: center;"><?=$this->session->flashdata('msg_alert');?></label>
              </div>
              <?php } ?>
              <?=form_open_multipart('regis_pengguna/regisstaff', array('method'=>'post'));?>
                ...
                <div class="row">
                  ...
                  <input type="hidden" name="id_bidang" class="form-control" value="3">
                </div>
