...
class M_DaftarKeluhan extends CI_Model {
	...
	public function add_new($id_namaizin,$tglawal,$tglakhir,$tempat) {
		...
		$this->session->set_flashdata('msg_alert', 'Keluhan berhasil diajukan');
	}
	...
	public function update($id_izin,$id_namaizin,$tglawal,$tglakhir,$tempat) {
		...
		$this->session->set_flashdata('msg_alert', 'Data Keluhan berhasil diubah');
	}
