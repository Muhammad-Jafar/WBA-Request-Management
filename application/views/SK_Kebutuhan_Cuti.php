...
<body>
  <div class="page-portrait">
    ...
    <hr height="2" width="90%" color="#000000" border-style="inset" border-width="3px"/>
      <h4 style="text-align:center">SURAT IJIN CUTI</h4>
    <hr height="2" width="90%" color="#000000" border-style="inset" border-width="3px"/>
        ...
        <td>
          <table width="100%" border="0" cellspacing="1" cellpadding="1">
            <tr> 
              ...
              <td width="70%">: 0<?=$id;?> / Pengajuan Cuti / <?=date('Y');?></td>
            </tr>
            <tr> 
              <td width="15%">Perihal</td>
              <td width="70%">: Pengajuan <?=$type_id;?></td>
            </tr>
          </table>
        </td>
      </div>
    ...
    <br>  
    <tr>
      <td> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Bermaksud untuk mengajukan ijin <?=$type;?> <?=$nama_kebutuhan?> selama <?=$selama;?>, terhitung mulai tanggal <?=$tgl_mulai;?> sampai dengan <?=$tgl_akhir;?>.<br></td>
    </tr>
    <tr>
      <td> &ensp;&ensp;&ensp;&ensp;&ensp;&ensp;Demikian surat pengajuan keluhan ini dibuat agar dapat dipergunakan sebagaimana mestinya, atas perhatian dan kebijaksanaannya saya ucapkan banyak terima kasih.</td>
    </tr>
    <tr>
